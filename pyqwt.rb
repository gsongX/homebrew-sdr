class Pyqwt < Formula
  ...
  # Fix building using sip 4.19
  # info : https://aur.archlinux.org/packages/python-poppler-qt4/
  # patch : http://pkgs.fedoraproject.org/cgit/rpms/PyQwt.git/tree/PyQwt-5.2.0-sip-4.19.patch?id=974991cfedfa7973fb1349b47e28632741ae1996
  patch do
    url "https://raw.githubusercontent.com/gsong2014/homebrew-sdr/master/patch/PyQwt-5.2.0-sip-4.19.patch"
    sha256 "5d036802f085a7f68fa276a4bbea5088dc4d53e26a0e6933fafadb90ef7bc773"
  end
