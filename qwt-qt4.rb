class QwtQt4 < Formula
  ...
  test do
    ...
    system ENV.cxx, "test.cpp", "-o", "out",
      ...
      "-F#{lib}", "-F#{Formula["gsong2014/sdr/qt"].opt_lib}",
      "-I#{lib}/qwt.framework/Headers",
      "-I#{Formula["gsong2014/sdr/qt"].opt_lib}/QtCore.framework/Headers",
      "-I#{Formula["gsong2014/sdr/qt"].opt_lib}/QtGui.framework/Headers"
    system "./out"
  end
end
